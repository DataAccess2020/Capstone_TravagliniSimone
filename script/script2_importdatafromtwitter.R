...
list_italian_cdx[1] #i try to see the second name in the list, in order to see if all is ok
## ok, now i have the list of the most important candidate and politicians from the right coalitions
